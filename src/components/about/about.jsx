        ...
        <div className="about-data">
          <div className="about-info">
            <p className="about-description">
              ...
              JavaScript, and expertise in frameworks like React JS, Tailwind
              CSS and .NET. I have a passion for graphic design and a keen eye
              for aesthetics, which I incorporate into my web development
              projects to create visually appealing and functional designs. I'm
